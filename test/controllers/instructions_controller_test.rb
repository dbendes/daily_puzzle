...
class InstructionsControllerTest < ActionController::TestCase
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post :create, instruction: { description: @instruction.description, game: @instruction.game, url: @instruction.url }
    end
  ...
  test "should update instruction" do
    patch :update, id: @instruction, instruction: { description: @instruction.description, game: @instruction.game, url: @instruction.url }
    assert_redirected_to instruction_path(assigns(:instruction))
  end
