...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { date: @score.date, game_id: @score.game_id, user_id: @score.user_id, value: @score.value }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { date: @score.date, game_id: @score.game_id, user_id: @score.user_id, value: @score.value }
    assert_redirected_to score_path(assigns(:score))
  end
