...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { group_id: @membership.group_id, type: @membership.type, user_id: @membership.user_id }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { group_id: @membership.group_id, type: @membership.type, user_id: @membership.user_id }
    assert_redirected_to membership_path(assigns(:membership))
  end
